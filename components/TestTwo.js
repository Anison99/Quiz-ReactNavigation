...
import data from '../mechanics/QuizDataSecond';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons';


export default function TestOne({ navigation }) {
        ...
        return (
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={{
                        flexDirection: 'row', justifyContent: 'space-between', color: '#fff', fontSize: 20
                    }}>Time {counter} </Text>
